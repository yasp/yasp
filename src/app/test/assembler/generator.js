...
(function() {
  ...
  var generator_cases = [
    ...
    {input: "MOV b0, b1", result: "000100000000000000000001", map: { 0: 0 }},
    {input: "MOV W0, 1337", result: "00100000000000000000010100111001", map: { 0: 0 }},
    {input: "MOV W0, W1", result: "000100000100000000000001", map: { 0: 0 }}
  ];
